...
const MODES = [
  { id: "time", label: "Time", icon: Clock, description: "Race against the clock" },
  { id: "words", label: "Words", icon: BookOpen, description: "Type a set number of words" },
  { id: "quote", label: "Quote", icon: Quote, description: "Type famous quotes" },
  { id: "zen", label: "Zen", icon: Sparkles, description: "No timer, just flow" },
]
    ...
    <motion.div className="max-w-4xl mx-auto" variants={containerVariants} initial="hidden" animate="visible">
      ...
      <motion.div className="text-center mb-16" variants={itemVariants}>
        ...
        <motion.p className="text-lg text-muted-foreground max-w-2xl mx-auto" variants={itemVariants}>
          Choose your test mode and duration to measure your typing speed, accuracy, and improve your skills
        </motion.p>
      </motion.div>
            ...
            {MODES.map((m, idx) => {
              ...
              return (
                <motion.button
                  ...
                  onClick={() => {
                    setMode(m.id)
                    setDuration(DURATIONS[m.id as keyof typeof DURATIONS]?.[0] || 60)
                  }}
